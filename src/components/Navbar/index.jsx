            ...
            <AppBar position="static" elevation={0}>
                <Container maxWidth="xs">
                    <Toolbar disableGutters>
                        {mainPageList.includes(pathname) || pathname.startsWith("/u/settings-work") ? (
                                            ...
                                            {user.role === "admin" ? (
                                                pathname.startsWith("/headquarter") ? (
                                                    user.role === "admin" && (
                                                        ...
                                                        >
                                                            <Typography textAlign="center">Go to user panel</Typography>
                                                        </MenuItem>
                                                    )
                                                ) : (
                                                    <MenuItem
                                                    ...
                                                    >
                                                        <Typography textAlign="center">Go to headquarter</Typography>
                                                    </MenuItem>
                                                )
                                            ) : null}
                                            <MenuItem
